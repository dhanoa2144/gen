...
<div id="user_login">
	...
	if ( ! $action || 'eb_register' !== $action ) {
		?>
		<div class="eb-wrap-login-form mx-auto">
			...
			<form method="post" class="login">
				...
				<p class="form-row form-row-wide form-group">
					<label for="wdm_username">
						<?php _e( 'Username', 'eb-textdomain' ); ?>
						<span class="required">*</span>
					</label>
					<input type="text" class="input-text form-control" placeholder="<?php _e( "Enter user name", "eb-textdomain" ); ?>" name="wdm_username" id="wdm_username" value="<?php echo esc_attr( $username ); ?>" />
				</p>
				<p class="form-row form-row-wide form-group">
					...
					<input class="input-text form-control" type="password" placeholder="<?php _e( "Enter password", "eb-textdomain" ); ?>" name="wdm_password" id="wdm_password" />
				</p>

				<?php do_action( 'eb_login_form' ); ?>

				<p class="form-row form-check">
					<?php wp_nonce_field( 'eb-login' ); ?>
					<input name="rememberme" type="checkbox" id="rememberme" value="forever" class="form-check-input" />
					<label for="rememberme" class="inline form-check-label">
						<?php _e( 'Remember me', 'eb-textdomain' ); ?>
					</label>
				</p>

				<p class="text-center">
					<input type="submit" class="eb-login-button button btn btn-primary" name="wdm_login" value="<?php _e( 'Login', 'eb-textdomain' ); ?>" />
				</p>

				<p class="lost_password form-row">
					<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" class="btn btn-link mx-auto"><?php _e( 'Forgot password', 'eb-textdomain' ); ?></a>
				</p>
				<?php
